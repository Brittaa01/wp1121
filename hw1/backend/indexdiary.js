...
// Routes
import mydiaryRouter from "./routes/mydiary.js";
...
app.use("/api/mydiary", mydiaryRouter);

app.get("/heartbeat", (_, res) => {
  return res.send({ message: "Hello World!" });
});
const url = "mongodb+srv://brittadkarlsson:VpWfMilc62NINtny@cluster1.wdkp0di.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp";
